...
$_['lang_limit_reached']       		= 'The maximum number of checks per request was reached, clic the button to continue searching';
...
$_['lang_column_product_auto']      = 'Product<span class="help">(Autocompletar from name)</span>';
