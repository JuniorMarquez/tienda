...
$_['lang_help_support_description']     = 'You should read our fAQ section to see if your question is already answered <a href="http://shop.openbaypro.com/index.php?route=information/faq" title="OpenBay pro for openCart support fAQ">here</a>. <br />If you cannot find an answer then you can create a support ticket, <a href="http://support.welfordmedia.co.uk" title="OpenBay pro for openCart support site">clic here</a>';
$_['lang_help_template_title']          = 'Creating eBay templates';
$_['lang_help_template_description']    = 'Information for developers &amp; designers on creating custom templates for their eBay listings, <a href="http://shop.openbaypro.com/index.php?route=information/faq&topic=30" title="OpenBay prohTML templates for eBay">clic here</a>';

$_['lang_tab_help']                     = 'Help';
$_['lang_help_guide']                   = 'User guides';
$_['lang_help_guide_description']       = 'To download and view the eBay and amazon user guides <a href="http://shop.openbaypro.com/index.php?route=information/faq&topic=37" title="OpenBay pro user guides">clic here</a>';
